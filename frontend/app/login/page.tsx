...
export default function LoginPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[linear-gradient(135deg,#0f172a_0%,#0f766e_48%,#f59e0b_100%)] px-4 py-10 text-white">
      <section className="w-full max-w-md rounded-lg border border-white/20 bg-slate-950/45 p-8 shadow-2xl shadow-slate-950/30 backdrop-blur-xl">
        ...
        <p className="mb-6 mt-2 text-sm leading-6 text-teal-50/80">
            Use the account created in the ASP.NET Core backend.
        </p>
        <LoginForm />
      </section>
    </main>
